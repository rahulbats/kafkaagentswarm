...
KIND_CLUSTER ?= kafkaagentswarm-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kafkaagentswarm-builder
	$(CONTAINER_TOOL) buildx use kafkaagentswarm-builder
	...
	- $(CONTAINER_TOOL) buildx rm kafkaagentswarm-builder
	rm Dockerfile.cross
