...
import (
	...
	"github.com/rahulbats/kafkaagentswarm/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6fe5fb3f.kafkaagentswarm.io",
	...
	if err := (&controller.AgentSwarmReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "agentswarm")
		os.Exit(1)
	}
